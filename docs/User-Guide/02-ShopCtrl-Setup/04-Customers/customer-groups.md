...
![customer-groups-overview](/img/customer-groups-overview.png)
...
![customer-group-create](/img/customer-group-create.png)

## Assign customer to a group

![customer-group-assign-customer](/img/customer-group-assign-customer.png)
