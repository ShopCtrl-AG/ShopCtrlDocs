...
Service level agreement performance data could be viewed and analyzed through a variety of reports - [Service Level Reporting](/docs/User-Guide/03-Basic-Functions/reporting.md#service-level-reporting).

For additional information, please refer to: [Ticket Configuration](/docs/User-Guide/06-Communication/Tickets/ticket-configuration.md) and [Working with Tickets](/User-Guide/06-Communication/Tickets/working-with-tickets.md).
...
The Office hours record allows to set openining and closing working hours per day of the week, independantly from the time zone the shop is located in. Time zone is defined on a shop configuration page.
...
4.  Proceed to set up the SLA for the **Default** communication channel. These settings will be used as a fallback if the specific communication channel's SLA is not defined.
    ...
    5.       Enable the confiruation for the designated communication channel.
